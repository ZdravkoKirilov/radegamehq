...
=======
# Generated by Django 2.1.1 on 2019-04-22 06:09
>>>>>>> a10403863e2fcc3312e317d6b94ba4b2364c2e85
...
<<<<<<< HEAD
=======
                ('keywords', models.ManyToManyField(blank=True, related_name='keywords_keywords', to='api.Keyword')),
>>>>>>> a10403863e2fcc3312e317d6b94ba4b2364c2e85
            ],
            options={
                'abstract': False,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('game', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='api.Game')),
                ('image', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='api.ImageAsset')),
                ('keywords', models.ManyToManyField(blank=True, related_name='keywords_phases', to='api.Keyword')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='api.ImageAsset')),
                ('keywords', models.ManyToManyField(blank=True, related_name='keywords_sources', to='api.Keyword')),
            ],
            options={
                'abstract': False,
            },
...
<<<<<<< HEAD
=======
                ('keywords', models.ManyToManyField(blank=True, related_name='keywords_stages', to='api.Keyword')),
>>>>>>> a10403863e2fcc3312e317d6b94ba4b2364c2e85
            ],
            options={
                'abstract': False,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('game', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='api.Game')),
                ('image', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='api.ImageAsset')),
                ('keywords', models.ManyToManyField(blank=True, related_name='keywords_styles', to='api.Keyword')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('game', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='api.Game')),
                ('image', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='api.ImageAsset')),
                ('keywords', models.ManyToManyField(blank=True, related_name='keywords_teams', to='api.Keyword')),
