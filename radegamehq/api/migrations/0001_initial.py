# Generated by Django 2.1.1 on 2018-10-13 16:28

import api.mixins.EntityBase
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('api_auth', '0003_appuser_is_authenticated'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            bases=(models.Model, api.mixins.EntityBase.EntityBase),
        ),
        migrations.CreateModel(
            name='ActionConfig',
            fields=[
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ImageField(blank=True, max_length=200, null=True, upload_to='trivia_images')),
            ],
        ),
        migrations.CreateModel(
            name='Condition',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('penalty', models.ManyToManyField(related_name='field_penalty', to='api.EffectStack')),
            ],
            bases=(models.Model, api.mixins.EntityBase.EntityBase),
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.FileField(blank=True, max_length=200, null=True, upload_to='game_images')),
                ('hide_factions', models.NullBooleanField()),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ImageField(blank=True, max_length=200, null=True, upload_to='trivia_answer_images')),
                ('trivia', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='answers', to='api.Choice')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('answer', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='effect', to='api.TriviaAnswer')),
            ],
        ),
        migrations.AddField(
            model_name='round',
